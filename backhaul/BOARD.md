...
| [SAT_036](tickets/SAT_036_log-noise-followup.md) | Satchel | low | Retro-track two shared-framework log fixes | SAT_035 changed SatchelException and Tracer outside its scope. Curtis flagged both for splitting out. | [Edit](editmd:///C:/_local/mcRepos/backhaul/tickets/SAT_036_log-noise-followup.md) |
