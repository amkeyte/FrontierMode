...
| [SAT_038](tickets/SAT_038_booter-visibility.md) | Satchel | low | Narrow LogicalFoundation.booter() to private | Found while designing SAT_037/RM_SAT_022 (Roger). No real external caller -- grep confirms only installConfigs()'s own booter().engine() call and one dead commented-out line elsewhere. | [Edit](editmd:///C:/_local/mcRepos/backhaul/tickets/SAT_038_booter-visibility.md) |
